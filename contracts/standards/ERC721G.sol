...
contract ERC721G is Context, ERC165, IERC721G, IERC721Metadata, AccessControl, Pausable {
    ...
    function setBaseURI(string calldata baseURI_) external virtual {
        require(hasRole(METADATA_OPERATOR_ROLE, msg.sender), "ERC721G: must have metadata operator role to setBaseURI");
    ...
    function _burnBatch(address from, uint256[] calldata tokenIds) internal virtual {
